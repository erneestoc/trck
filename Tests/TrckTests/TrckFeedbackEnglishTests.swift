...
class TrckFeedbackEnglishTests: XCTestCase {
  ...
  func testVoiceFeedbackForKilometers() {
    ...
    let string2 = "distance, 2 kilometers, completed, time, 10 minutes, 0 seconds, average pace, 5, 0, per kilometer"
  ...
  func testVoiceFeedbackForMiles() {
    ...
    let string = "distance, 1 mile, completed, time, 5 minutes, 0 seconds, average pace, 5, 0, per mile"
    ...
    let string2 = "distance, 2 miles, completed, time, 10 minutes, 0 seconds, average pace, 5, 0, per mile"
  ...
  func testHalfKilometerConfig() {
    ...
    XCTAssertNotEqual(overKM, nil)
    let str = "distance, point, 5, kilometers, completed, time, 5 minutes, 0 seconds, average pace, 5, 0, per kilometer"
    ...
    XCTAssertNotEqual(over2ndKM, nil)
    let string2 = "distance, 1 kilometer, completed, time, 5 minutes, 0 seconds, average pace, 5, 0, per kilometer"
    XCTAssertEqual(over2ndKM!, string2)
  }
  ...
  func testHalfMileConfig() {
    ...
    XCTAssertNotEqual(overKM, nil)
    let str = "distance, point, 5, kilometers, completed, time, 5 minutes, 0 seconds, average pace, 5, 0, per mile"
    XCTAssertEqual(overKM!, str)
    ...
    XCTAssertNotEqual(over2ndKM, nil)
    let string2 = "distance, 1 kilometer, completed, time, 5 minutes, 0 seconds, average pace, 5, 0, per mile"
    XCTAssertEqual(over2ndKM!, string2)
  }
